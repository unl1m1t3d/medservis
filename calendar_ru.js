...
document.write('<table id="fc" style="position:absolute;z-index:10500;border-collapse:collapse;background:#FFFFFF;border:1px solid #303030;display:none;-moz-user-select:none;-khtml-user-select:none;user-select:none;" cellpadding=2>');
...
function lcs(ielem) {
	...
	getObj('fc').style.position=findPosition(ielem);
